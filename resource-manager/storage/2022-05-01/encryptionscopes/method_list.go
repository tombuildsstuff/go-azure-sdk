...
func (c EncryptionScopesClient) ListCompleteMatchingPredicate(ctx context.Context, id commonids.StorageAccountId, predicate EncryptionScopeOperationPredicate) (result ListCompleteResult, err error) {
