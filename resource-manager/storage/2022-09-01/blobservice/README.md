...
## `github.com/tombuildsstuff/go-azure-sdk/resource-manager/storage/2022-09-01/blobservice` Documentation

The `blobservice` SDK allows for interaction with the Azure Resource Manager Service `storage` (API Version `2022-09-01`).
...
```go
import "github.com/tombuildsstuff/go-azure-sdk/resource-manager/storage/2022-09-01/blobservice"
```
