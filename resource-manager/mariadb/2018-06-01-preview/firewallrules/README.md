...
## `github.com/tombuildsstuff/go-azure-sdk/resource-manager/mariadb/2018-06-01-preview/firewallrules` Documentation

The `firewallrules` SDK allows for interaction with the Azure Resource Manager Service `mariadb` (API Version `2018-06-01-preview`).
...
```go
import "github.com/tombuildsstuff/go-azure-sdk/resource-manager/mariadb/2018-06-01-preview/firewallrules"
```
