...
func (c UpdateConfigurationsClient) ServerParametersListUpdateConfigurations(ctx context.Context, id ServerId, input ConfigurationListResult) (result ServerParametersListUpdateConfigurationsOperationResponse, err error) {
...
func (c UpdateConfigurationsClient) ServerParametersListUpdateConfigurationsThenPoll(ctx context.Context, id ServerId, input ConfigurationListResult) error {
