...
## `github.com/tombuildsstuff/go-azure-sdk/resource-manager/cognitive/2023-05-01/privateendpointconnections` Documentation

The `privateendpointconnections` SDK allows for interaction with the Azure Resource Manager Service `cognitive` (API Version `2023-05-01`).
...
```go
import "github.com/tombuildsstuff/go-azure-sdk/resource-manager/cognitive/2023-05-01/privateendpointconnections"
```
