...
## `github.com/tombuildsstuff/go-azure-sdk/resource-manager/mysql/2017-12-01/servers` Documentation

The `servers` SDK allows for interaction with the Azure Resource Manager Service `mysql` (API Version `2017-12-01`).
...
```go
import "github.com/tombuildsstuff/go-azure-sdk/resource-manager/mysql/2017-12-01/servers"
```
