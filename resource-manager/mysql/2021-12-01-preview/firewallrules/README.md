...
## `github.com/tombuildsstuff/go-azure-sdk/resource-manager/mysql/2021-12-01-preview/firewallrules` Documentation

The `firewallrules` SDK allows for interaction with the Azure Resource Manager Service `mysql` (API Version `2021-12-01-preview`).
...
```go
import "github.com/tombuildsstuff/go-azure-sdk/resource-manager/mysql/2021-12-01-preview/firewallrules"
```
