...
## `github.com/tombuildsstuff/go-azure-sdk/resource-manager/consumption/2023-11-01/reservationrecommendationdetails` Documentation

The `reservationrecommendationdetails` SDK allows for interaction with the Azure Resource Manager Service `consumption` (API Version `2023-11-01`).
...
```go
import "github.com/tombuildsstuff/go-azure-sdk/resource-manager/consumption/2023-11-01/reservationrecommendationdetails"
```
