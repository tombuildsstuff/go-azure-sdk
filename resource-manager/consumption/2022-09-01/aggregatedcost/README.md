...
## `github.com/tombuildsstuff/go-azure-sdk/resource-manager/consumption/2022-09-01/aggregatedcost` Documentation

The `aggregatedcost` SDK allows for interaction with the Azure Resource Manager Service `consumption` (API Version `2022-09-01`).
...
```go
import "github.com/tombuildsstuff/go-azure-sdk/resource-manager/consumption/2022-09-01/aggregatedcost"
```
