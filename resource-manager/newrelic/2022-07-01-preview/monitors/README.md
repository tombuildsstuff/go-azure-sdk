...
## `github.com/tombuildsstuff/go-azure-sdk/resource-manager/newrelic/2022-07-01-preview/monitors` Documentation

The `monitors` SDK allows for interaction with the Azure Resource Manager Service `newrelic` (API Version `2022-07-01-preview`).
...
```go
import "github.com/tombuildsstuff/go-azure-sdk/resource-manager/newrelic/2022-07-01-preview/monitors"
```
