...
## `github.com/tombuildsstuff/go-azure-sdk/resource-manager/connectedvmware/2023-10-01/virtualnetworks` Documentation

The `virtualnetworks` SDK allows for interaction with the Azure Resource Manager Service `connectedvmware` (API Version `2023-10-01`).
...
```go
import "github.com/tombuildsstuff/go-azure-sdk/resource-manager/connectedvmware/2023-10-01/virtualnetworks"
```
