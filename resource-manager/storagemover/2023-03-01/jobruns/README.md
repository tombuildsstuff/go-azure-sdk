...
## `github.com/tombuildsstuff/go-azure-sdk/resource-manager/storagemover/2023-03-01/jobruns` Documentation

The `jobruns` SDK allows for interaction with the Azure Resource Manager Service `storagemover` (API Version `2023-03-01`).
...
```go
import "github.com/tombuildsstuff/go-azure-sdk/resource-manager/storagemover/2023-03-01/jobruns"
```
