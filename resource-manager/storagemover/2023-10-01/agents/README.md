...
## `github.com/tombuildsstuff/go-azure-sdk/resource-manager/storagemover/2023-10-01/agents` Documentation

The `agents` SDK allows for interaction with the Azure Resource Manager Service `storagemover` (API Version `2023-10-01`).
...
```go
import "github.com/tombuildsstuff/go-azure-sdk/resource-manager/storagemover/2023-10-01/agents"
```
