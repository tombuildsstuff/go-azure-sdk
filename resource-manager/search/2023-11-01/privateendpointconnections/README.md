...
## `github.com/tombuildsstuff/go-azure-sdk/resource-manager/search/2023-11-01/privateendpointconnections` Documentation

The `privateendpointconnections` SDK allows for interaction with the Azure Resource Manager Service `search` (API Version `2023-11-01`).
...
```go
import "github.com/tombuildsstuff/go-azure-sdk/resource-manager/search/2023-11-01/privateendpointconnections"
```
