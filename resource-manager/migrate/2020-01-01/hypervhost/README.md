...
## `github.com/tombuildsstuff/go-azure-sdk/resource-manager/migrate/2020-01-01/hypervhost` Documentation

The `hypervhost` SDK allows for interaction with the Azure Resource Manager Service `migrate` (API Version `2020-01-01`).
...
```go
import "github.com/tombuildsstuff/go-azure-sdk/resource-manager/migrate/2020-01-01/hypervhost"
```
