...
## `github.com/tombuildsstuff/go-azure-sdk/resource-manager/purview/2021-12-01/defaultaccount` Documentation

The `defaultaccount` SDK allows for interaction with the Azure Resource Manager Service `purview` (API Version `2021-12-01`).
...
```go
import "github.com/tombuildsstuff/go-azure-sdk/resource-manager/purview/2021-12-01/defaultaccount"
```
