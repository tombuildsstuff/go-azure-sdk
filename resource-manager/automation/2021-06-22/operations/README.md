...
## `github.com/tombuildsstuff/go-azure-sdk/resource-manager/automation/2021-06-22/operations` Documentation

The `operations` SDK allows for interaction with the Azure Resource Manager Service `automation` (API Version `2021-06-22`).
...
```go
import "github.com/tombuildsstuff/go-azure-sdk/resource-manager/automation/2021-06-22/operations"
```
