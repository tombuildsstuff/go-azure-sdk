...
## `github.com/tombuildsstuff/go-azure-sdk/resource-manager/automation/2019-06-01/connectiontype` Documentation

The `connectiontype` SDK allows for interaction with the Azure Resource Manager Service `automation` (API Version `2019-06-01`).
...
```go
import "github.com/tombuildsstuff/go-azure-sdk/resource-manager/automation/2019-06-01/connectiontype"
```
