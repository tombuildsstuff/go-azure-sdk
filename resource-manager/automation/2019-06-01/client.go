...
import (
	...
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/automation/2019-06-01/activity"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/automation/2019-06-01/agentregistrationinformation"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/automation/2019-06-01/automationaccount"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/automation/2019-06-01/certificate"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/automation/2019-06-01/connection"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/automation/2019-06-01/connectiontype"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/automation/2019-06-01/credential"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/automation/2019-06-01/dsccompilationjob"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/automation/2019-06-01/dscconfiguration"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/automation/2019-06-01/dscnode"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/automation/2019-06-01/dscnodeconfiguration"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/automation/2019-06-01/hybridrunbookworkergroup"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/automation/2019-06-01/job"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/automation/2019-06-01/jobschedule"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/automation/2019-06-01/jobstream"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/automation/2019-06-01/linkedworkspace"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/automation/2019-06-01/listkeys"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/automation/2019-06-01/module"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/automation/2019-06-01/nodecountinformation"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/automation/2019-06-01/nodereports"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/automation/2019-06-01/objectdatatypes"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/automation/2019-06-01/python2package"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/automation/2019-06-01/runbook"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/automation/2019-06-01/runbookdraft"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/automation/2019-06-01/schedule"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/automation/2019-06-01/softwareupdateconfiguration"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/automation/2019-06-01/softwareupdateconfigurationmachinerun"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/automation/2019-06-01/softwareupdateconfigurationrun"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/automation/2019-06-01/sourcecontrol"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/automation/2019-06-01/sourcecontrolsyncjob"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/automation/2019-06-01/sourcecontrolsyncjobstreams"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/automation/2019-06-01/statistics"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/automation/2019-06-01/testjob"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/automation/2019-06-01/testjobstream"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/automation/2019-06-01/typefields"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/automation/2019-06-01/usages"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/automation/2019-06-01/variable"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/automation/2019-06-01/watcher"
)
