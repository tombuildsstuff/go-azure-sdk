...
import (
	...
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/sql/2023-02-01-preview/backupshorttermretentionpolicies"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/sql/2023-02-01-preview/blobauditing"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/sql/2023-02-01-preview/databaseadvancedthreatprotectionsettings"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/sql/2023-02-01-preview/databaseadvisors"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/sql/2023-02-01-preview/databaseautomatictuning"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/sql/2023-02-01-preview/databasecolumns"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/sql/2023-02-01-preview/databaseencryptionprotectorrevalidate"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/sql/2023-02-01-preview/databaseencryptionprotectorrevert"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/sql/2023-02-01-preview/databaseextensions"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/sql/2023-02-01-preview/databaseoperations"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/sql/2023-02-01-preview/databaserecommendedactions"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/sql/2023-02-01-preview/databases"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/sql/2023-02-01-preview/databaseschemas"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/sql/2023-02-01-preview/databasesecurityalertpolicies"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/sql/2023-02-01-preview/databasesqlvulnerabilityassessmentbaselines"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/sql/2023-02-01-preview/databasesqlvulnerabilityassessmentexecutescan"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/sql/2023-02-01-preview/databasesqlvulnerabilityassessmentrulebaselines"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/sql/2023-02-01-preview/databasesqlvulnerabilityassessmentscanresult"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/sql/2023-02-01-preview/databasesqlvulnerabilityassessmentscans"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/sql/2023-02-01-preview/databasesqlvulnerabilityassessmentssettings"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/sql/2023-02-01-preview/databasetables"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/sql/2023-02-01-preview/databaseusages"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/sql/2023-02-01-preview/databasevulnerabilityassessmentrulebaselines"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/sql/2023-02-01-preview/databasevulnerabilityassessments"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/sql/2023-02-01-preview/databasevulnerabilityassessmentscans"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/sql/2023-02-01-preview/datamaskingpolicies"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/sql/2023-02-01-preview/datamaskingrules"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/sql/2023-02-01-preview/datawarehouseuseractivities"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/sql/2023-02-01-preview/deletedservers"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/sql/2023-02-01-preview/distributedavailabilitygroups"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/sql/2023-02-01-preview/elasticpooloperations"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/sql/2023-02-01-preview/elasticpools"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/sql/2023-02-01-preview/encryptionprotectors"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/sql/2023-02-01-preview/endpointcertificates"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/sql/2023-02-01-preview/failovergroups"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/sql/2023-02-01-preview/firewallrules"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/sql/2023-02-01-preview/geobackuppolicies"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/sql/2023-02-01-preview/instancefailovergroups"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/sql/2023-02-01-preview/instancepools"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/sql/2023-02-01-preview/ipv6firewallrules"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/sql/2023-02-01-preview/jobagents"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/sql/2023-02-01-preview/jobcredentials"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/sql/2023-02-01-preview/jobexecutions"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/sql/2023-02-01-preview/jobs"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/sql/2023-02-01-preview/jobstepexecutions"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/sql/2023-02-01-preview/jobsteps"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/sql/2023-02-01-preview/jobtargetexecutions"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/sql/2023-02-01-preview/jobtargetgroups"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/sql/2023-02-01-preview/jobversions"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/sql/2023-02-01-preview/ledgerdigestuploads"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/sql/2023-02-01-preview/locationcapabilities"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/sql/2023-02-01-preview/longtermretentionbackups"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/sql/2023-02-01-preview/longtermretentionmanagedinstancebackups"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/sql/2023-02-01-preview/longtermretentionpolicies"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/sql/2023-02-01-preview/maintenancewindowoptions"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/sql/2023-02-01-preview/maintenancewindows"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/sql/2023-02-01-preview/managedbackupshorttermretentionpolicies"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/sql/2023-02-01-preview/manageddatabaseadvancedthreatprotectionsettings"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/sql/2023-02-01-preview/manageddatabasecolumns"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/sql/2023-02-01-preview/manageddatabasemoveoperations"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/sql/2023-02-01-preview/manageddatabasequeries"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/sql/2023-02-01-preview/manageddatabaserestoredetails"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/sql/2023-02-01-preview/manageddatabases"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/sql/2023-02-01-preview/manageddatabaseschemas"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/sql/2023-02-01-preview/manageddatabasesecurityalertpolicies"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/sql/2023-02-01-preview/manageddatabasesecurityevents"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/sql/2023-02-01-preview/manageddatabasesensitivitylabels"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/sql/2023-02-01-preview/manageddatabasetables"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/sql/2023-02-01-preview/manageddatabasetransparentdataencryption"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/sql/2023-02-01-preview/manageddatabasevulnerabilityassessmentrulebaselines"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/sql/2023-02-01-preview/manageddatabasevulnerabilityassessments"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/sql/2023-02-01-preview/manageddatabasevulnerabilityassessmentscans"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/sql/2023-02-01-preview/managedinstanceadministrators"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/sql/2023-02-01-preview/managedinstanceadvancedthreatprotectionsettings"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/sql/2023-02-01-preview/managedinstanceazureadonlyauthentications"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/sql/2023-02-01-preview/managedinstancedtcs"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/sql/2023-02-01-preview/managedinstanceencryptionprotectors"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/sql/2023-02-01-preview/managedinstancekeys"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/sql/2023-02-01-preview/managedinstancelongtermretentionpolicies"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/sql/2023-02-01-preview/managedinstanceoperations"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/sql/2023-02-01-preview/managedinstanceprivateendpointconnections"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/sql/2023-02-01-preview/managedinstanceprivatelinkresources"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/sql/2023-02-01-preview/managedinstances"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/sql/2023-02-01-preview/managedinstancetdecertificates"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/sql/2023-02-01-preview/managedinstancevulnerabilityassessments"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/sql/2023-02-01-preview/managedledgerdigestuploads"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/sql/2023-02-01-preview/managedrestorabledroppeddatabasebackupshorttermretentionpolicies"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/sql/2023-02-01-preview/managedserverdnsaliases"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/sql/2023-02-01-preview/managedserversecurityalertpolicies"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/sql/2023-02-01-preview/networksecurityperimeterconfigurations"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/sql/2023-02-01-preview/outboundfirewallrules"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/sql/2023-02-01-preview/privateendpointconnections"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/sql/2023-02-01-preview/privatelinkresources"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/sql/2023-02-01-preview/recoverabledatabases"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/sql/2023-02-01-preview/recoverablemanageddatabases"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/sql/2023-02-01-preview/replicationlinks"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/sql/2023-02-01-preview/restorabledroppeddatabases"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/sql/2023-02-01-preview/restorabledroppedmanageddatabases"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/sql/2023-02-01-preview/restorepoints"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/sql/2023-02-01-preview/sensitivitylabels"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/sql/2023-02-01-preview/serveradvancedthreatprotectionsettings"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/sql/2023-02-01-preview/serveradvisors"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/sql/2023-02-01-preview/serverautomatictuning"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/sql/2023-02-01-preview/serverazureadadministrators"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/sql/2023-02-01-preview/serverazureadonlyauthentications"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/sql/2023-02-01-preview/serverconfigurationoptions"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/sql/2023-02-01-preview/serverconnectionpolicies"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/sql/2023-02-01-preview/serverdevopsaudit"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/sql/2023-02-01-preview/serverdnsaliases"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/sql/2023-02-01-preview/serverkeys"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/sql/2023-02-01-preview/serveroperations"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/sql/2023-02-01-preview/servers"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/sql/2023-02-01-preview/serversecurityalertpolicies"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/sql/2023-02-01-preview/servertrustcertificates"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/sql/2023-02-01-preview/servertrustgroups"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/sql/2023-02-01-preview/serverusages"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/sql/2023-02-01-preview/servervulnerabilityassessments"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/sql/2023-02-01-preview/sqlagent"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/sql/2023-02-01-preview/sqlvulnerabilityassessmentbaseline"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/sql/2023-02-01-preview/sqlvulnerabilityassessmentexecutescan"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/sql/2023-02-01-preview/sqlvulnerabilityassessmentrulebaseline"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/sql/2023-02-01-preview/sqlvulnerabilityassessmentscanresult"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/sql/2023-02-01-preview/sqlvulnerabilityassessmentscans"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/sql/2023-02-01-preview/sqlvulnerabilityassessmentssettings"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/sql/2023-02-01-preview/startstopmanagedinstanceschedules"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/sql/2023-02-01-preview/subscriptionusages"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/sql/2023-02-01-preview/synapselinkworkspaces"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/sql/2023-02-01-preview/syncagents"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/sql/2023-02-01-preview/syncgroups"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/sql/2023-02-01-preview/syncmembers"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/sql/2023-02-01-preview/tdecertificates"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/sql/2023-02-01-preview/timezones"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/sql/2023-02-01-preview/transparentdataencryptions"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/sql/2023-02-01-preview/usages"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/sql/2023-02-01-preview/virtualclusters"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/sql/2023-02-01-preview/virtualnetworkrules"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/sql/2023-02-01-preview/workloadclassifiers"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/sql/2023-02-01-preview/workloadgroups"
