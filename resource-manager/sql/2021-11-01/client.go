...
import (
	...
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/sql/2021-11-01/backupshorttermretentionpolicies"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/sql/2021-11-01/blobauditing"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/sql/2021-11-01/databaseadvancedthreatprotectionsettings"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/sql/2021-11-01/databaseadvisors"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/sql/2021-11-01/databaseautomatictuning"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/sql/2021-11-01/databasecolumns"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/sql/2021-11-01/databaseextensions"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/sql/2021-11-01/databaseoperations"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/sql/2021-11-01/databaserecommendedactions"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/sql/2021-11-01/databases"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/sql/2021-11-01/databaseschemas"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/sql/2021-11-01/databasesecurityalertpolicies"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/sql/2021-11-01/databasetables"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/sql/2021-11-01/databaseusages"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/sql/2021-11-01/databasevulnerabilityassessmentrulebaselines"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/sql/2021-11-01/databasevulnerabilityassessments"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/sql/2021-11-01/databasevulnerabilityassessmentscans"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/sql/2021-11-01/datamaskingpolicies"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/sql/2021-11-01/datamaskingrules"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/sql/2021-11-01/datawarehouseuseractivities"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/sql/2021-11-01/deletedservers"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/sql/2021-11-01/distributedavailabilitygroups"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/sql/2021-11-01/elasticpooloperations"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/sql/2021-11-01/elasticpools"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/sql/2021-11-01/encryptionprotectors"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/sql/2021-11-01/endpointcertificates"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/sql/2021-11-01/failovergroups"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/sql/2021-11-01/firewallrules"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/sql/2021-11-01/geobackuppolicies"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/sql/2021-11-01/instancefailovergroups"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/sql/2021-11-01/instancepools"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/sql/2021-11-01/ipv6firewallrules"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/sql/2021-11-01/jobagents"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/sql/2021-11-01/jobcredentials"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/sql/2021-11-01/jobexecutions"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/sql/2021-11-01/jobs"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/sql/2021-11-01/jobstepexecutions"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/sql/2021-11-01/jobsteps"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/sql/2021-11-01/jobtargetexecutions"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/sql/2021-11-01/jobtargetgroups"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/sql/2021-11-01/jobversions"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/sql/2021-11-01/ledgerdigestuploads"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/sql/2021-11-01/locationcapabilities"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/sql/2021-11-01/longtermretentionbackups"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/sql/2021-11-01/longtermretentionmanagedinstancebackups"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/sql/2021-11-01/longtermretentionpolicies"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/sql/2021-11-01/maintenancewindowoptions"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/sql/2021-11-01/maintenancewindows"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/sql/2021-11-01/managedbackupshorttermretentionpolicies"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/sql/2021-11-01/manageddatabasecolumns"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/sql/2021-11-01/manageddatabasequeries"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/sql/2021-11-01/manageddatabaserestoredetails"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/sql/2021-11-01/manageddatabases"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/sql/2021-11-01/manageddatabaseschemas"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/sql/2021-11-01/manageddatabasesecurityalertpolicies"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/sql/2021-11-01/manageddatabasesecurityevents"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/sql/2021-11-01/manageddatabasesensitivitylabels"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/sql/2021-11-01/manageddatabasetables"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/sql/2021-11-01/manageddatabasetransparentdataencryption"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/sql/2021-11-01/manageddatabasevulnerabilityassessmentrulebaselines"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/sql/2021-11-01/manageddatabasevulnerabilityassessments"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/sql/2021-11-01/manageddatabasevulnerabilityassessmentscans"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/sql/2021-11-01/managedinstanceadministrators"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/sql/2021-11-01/managedinstanceazureadonlyauthentications"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/sql/2021-11-01/managedinstanceencryptionprotectors"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/sql/2021-11-01/managedinstancekeys"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/sql/2021-11-01/managedinstancelongtermretentionpolicies"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/sql/2021-11-01/managedinstanceoperations"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/sql/2021-11-01/managedinstanceprivateendpointconnections"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/sql/2021-11-01/managedinstanceprivatelinkresources"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/sql/2021-11-01/managedinstances"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/sql/2021-11-01/managedinstancetdecertificates"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/sql/2021-11-01/managedinstancevulnerabilityassessments"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/sql/2021-11-01/managedrestorabledroppeddatabasebackupshorttermretentionpolicies"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/sql/2021-11-01/managedserverdnsaliases"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/sql/2021-11-01/managedserversecurityalertpolicies"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/sql/2021-11-01/outboundfirewallrules"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/sql/2021-11-01/privateendpointconnections"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/sql/2021-11-01/privatelinkresources"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/sql/2021-11-01/recoverabledatabases"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/sql/2021-11-01/recoverablemanageddatabases"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/sql/2021-11-01/replicationlinks"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/sql/2021-11-01/restorabledroppeddatabases"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/sql/2021-11-01/restorabledroppedmanageddatabases"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/sql/2021-11-01/restorepoints"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/sql/2021-11-01/sensitivitylabels"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/sql/2021-11-01/serveradvancedthreatprotectionsettings"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/sql/2021-11-01/serveradvisors"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/sql/2021-11-01/serverautomatictuning"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/sql/2021-11-01/serverazureadadministrators"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/sql/2021-11-01/serverazureadonlyauthentications"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/sql/2021-11-01/serverconnectionpolicies"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/sql/2021-11-01/serverdevopsaudit"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/sql/2021-11-01/serverdnsaliases"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/sql/2021-11-01/serverkeys"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/sql/2021-11-01/serveroperations"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/sql/2021-11-01/servers"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/sql/2021-11-01/serversecurityalertpolicies"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/sql/2021-11-01/servertrustcertificates"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/sql/2021-11-01/servertrustgroups"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/sql/2021-11-01/serverusages"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/sql/2021-11-01/servervulnerabilityassessments"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/sql/2021-11-01/sqlagent"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/sql/2021-11-01/subscriptionusages"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/sql/2021-11-01/syncagents"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/sql/2021-11-01/syncgroups"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/sql/2021-11-01/syncmembers"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/sql/2021-11-01/tdecertificates"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/sql/2021-11-01/timezones"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/sql/2021-11-01/transparentdataencryptions"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/sql/2021-11-01/usages"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/sql/2021-11-01/virtualclusters"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/sql/2021-11-01/virtualnetworkrules"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/sql/2021-11-01/workloadclassifiers"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/sql/2021-11-01/workloadgroups"
