...
## `github.com/tombuildsstuff/go-azure-sdk/resource-manager/sql/2021-11-01/outboundfirewallrules` Documentation

The `outboundfirewallrules` SDK allows for interaction with the Azure Resource Manager Service `sql` (API Version `2021-11-01`).
...
```go
import "github.com/tombuildsstuff/go-azure-sdk/resource-manager/sql/2021-11-01/outboundfirewallrules"
```
