...
func (c ServerDevOpsAuditClient) SettingsCreateOrUpdate(ctx context.Context, id DevOpsAuditingSettingId, input ServerDevOpsAuditingSettings) (result SettingsCreateOrUpdateOperationResponse, err error) {
