...
## `github.com/tombuildsstuff/go-azure-sdk/resource-manager/containerapps/2023-05-01/containerappsrevisions` Documentation

The `containerappsrevisions` SDK allows for interaction with the Azure Resource Manager Service `containerapps` (API Version `2023-05-01`).
...
```go
import "github.com/tombuildsstuff/go-azure-sdk/resource-manager/containerapps/2023-05-01/containerappsrevisions"
```
