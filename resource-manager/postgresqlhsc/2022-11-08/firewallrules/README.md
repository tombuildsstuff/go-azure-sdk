...
## `github.com/tombuildsstuff/go-azure-sdk/resource-manager/postgresqlhsc/2022-11-08/firewallrules` Documentation

The `firewallrules` SDK allows for interaction with the Azure Resource Manager Service `postgresqlhsc` (API Version `2022-11-08`).
...
```go
import "github.com/tombuildsstuff/go-azure-sdk/resource-manager/postgresqlhsc/2022-11-08/firewallrules"
```
