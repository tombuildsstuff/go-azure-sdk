...
## `github.com/tombuildsstuff/go-azure-sdk/resource-manager/redhatopenshift/2022-04-01/openshiftclusters` Documentation

The `openshiftclusters` SDK allows for interaction with the Azure Resource Manager Service `redhatopenshift` (API Version `2022-04-01`).
...
```go
import "github.com/tombuildsstuff/go-azure-sdk/resource-manager/redhatopenshift/2022-04-01/openshiftclusters"
```
...
```go
ctx := context.TODO()
id := openshiftclusters.NewOpenShiftClusterID("12345678-1234-9876-4563-123456789012", "example-resource-group", "openShiftClusterValue")
