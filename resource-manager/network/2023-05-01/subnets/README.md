...
## `github.com/tombuildsstuff/go-azure-sdk/resource-manager/network/2023-05-01/subnets` Documentation

The `subnets` SDK allows for interaction with the Azure Resource Manager Service `network` (API Version `2023-05-01`).
...
```go
import "github.com/tombuildsstuff/go-azure-sdk/resource-manager/network/2023-05-01/subnets"
```
