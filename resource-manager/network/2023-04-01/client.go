...
import (
	...
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/network/2023-04-01/adminrulecollections"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/network/2023-04-01/adminrules"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/network/2023-04-01/applicationgatewayprivateendpointconnections"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/network/2023-04-01/applicationgatewayprivatelinkresources"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/network/2023-04-01/applicationgateways"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/network/2023-04-01/applicationgatewaywafdynamicmanifests"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/network/2023-04-01/applicationsecuritygroups"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/network/2023-04-01/availabledelegations"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/network/2023-04-01/availableservicealiases"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/network/2023-04-01/azurefirewalls"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/network/2023-04-01/bastionhosts"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/network/2023-04-01/bastionshareablelink"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/network/2023-04-01/bgpservicecommunities"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/network/2023-04-01/checkdnsavailabilities"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/network/2023-04-01/cloudservicepublicipaddresses"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/network/2023-04-01/connectionmonitors"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/network/2023-04-01/connectivityconfigurations"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/network/2023-04-01/customipprefixes"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/network/2023-04-01/ddoscustompolicies"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/network/2023-04-01/ddosprotectionplans"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/network/2023-04-01/dscpconfiguration"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/network/2023-04-01/dscpconfigurations"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/network/2023-04-01/endpointservices"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/network/2023-04-01/expressroutecircuitarptable"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/network/2023-04-01/expressroutecircuitauthorizations"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/network/2023-04-01/expressroutecircuitconnections"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/network/2023-04-01/expressroutecircuitpeerings"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/network/2023-04-01/expressroutecircuitroutestable"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/network/2023-04-01/expressroutecircuitroutestablesummary"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/network/2023-04-01/expressroutecircuits"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/network/2023-04-01/expressroutecircuitstats"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/network/2023-04-01/expressrouteconnections"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/network/2023-04-01/expressroutecrossconnectionarptable"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/network/2023-04-01/expressroutecrossconnectionpeerings"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/network/2023-04-01/expressroutecrossconnectionroutetable"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/network/2023-04-01/expressroutecrossconnectionroutetablesummary"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/network/2023-04-01/expressroutecrossconnections"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/network/2023-04-01/expressroutegateways"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/network/2023-04-01/expressroutelinks"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/network/2023-04-01/expressrouteportauthorizations"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/network/2023-04-01/expressrouteports"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/network/2023-04-01/expressrouteportslocations"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/network/2023-04-01/expressrouteproviderports"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/network/2023-04-01/expressrouteserviceproviders"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/network/2023-04-01/firewallpolicies"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/network/2023-04-01/firewallpolicyrulecollectiongroups"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/network/2023-04-01/flowlogs"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/network/2023-04-01/ipallocations"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/network/2023-04-01/ipgroups"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/network/2023-04-01/loadbalancers"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/network/2023-04-01/localnetworkgateways"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/network/2023-04-01/natgateways"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/network/2023-04-01/networkgroups"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/network/2023-04-01/networkinterfaces"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/network/2023-04-01/networkmanageractiveconfigurations"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/network/2023-04-01/networkmanageractiveconnectivityconfigurations"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/network/2023-04-01/networkmanagerconnections"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/network/2023-04-01/networkmanagereffectiveconnectivityconfiguration"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/network/2023-04-01/networkmanagereffectivesecurityadminrules"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/network/2023-04-01/networkmanagers"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/network/2023-04-01/networkprofiles"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/network/2023-04-01/networksecuritygroups"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/network/2023-04-01/networkvirtualappliances"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/network/2023-04-01/networkwatchers"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/network/2023-04-01/p2svpngateways"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/network/2023-04-01/packetcaptures"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/network/2023-04-01/peerexpressroutecircuitconnections"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/network/2023-04-01/privatednszonegroups"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/network/2023-04-01/privateendpoints"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/network/2023-04-01/privatelinkservice"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/network/2023-04-01/privatelinkservices"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/network/2023-04-01/publicipaddresses"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/network/2023-04-01/publicipprefixes"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/network/2023-04-01/routefilterrules"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/network/2023-04-01/routefilters"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/network/2023-04-01/routes"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/network/2023-04-01/routetables"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/network/2023-04-01/scopeconnections"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/network/2023-04-01/securityadminconfigurations"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/network/2023-04-01/securitypartnerproviders"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/network/2023-04-01/securityrules"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/network/2023-04-01/serviceendpointpolicies"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/network/2023-04-01/serviceendpointpolicydefinitions"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/network/2023-04-01/servicetags"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/network/2023-04-01/staticmembers"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/network/2023-04-01/subnets"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/network/2023-04-01/trafficanalytics"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/network/2023-04-01/usages"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/network/2023-04-01/vipswap"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/network/2023-04-01/virtualappliancesites"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/network/2023-04-01/virtualapplianceskus"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/network/2023-04-01/virtualnetworkgatewayconnections"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/network/2023-04-01/virtualnetworkgateways"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/network/2023-04-01/virtualnetworkpeerings"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/network/2023-04-01/virtualnetworks"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/network/2023-04-01/virtualnetworktap"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/network/2023-04-01/virtualnetworktaps"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/network/2023-04-01/virtualrouterpeerings"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/network/2023-04-01/virtualrouters"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/network/2023-04-01/virtualwans"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/network/2023-04-01/vmsspublicipaddresses"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/network/2023-04-01/vpngateways"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/network/2023-04-01/vpnlinkconnections"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/network/2023-04-01/vpnserverconfigurations"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/network/2023-04-01/vpnsites"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/network/2023-04-01/webapplicationfirewallpolicies"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/network/2023-04-01/webcategories"
