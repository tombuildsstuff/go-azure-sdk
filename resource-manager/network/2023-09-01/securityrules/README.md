...
## `github.com/tombuildsstuff/go-azure-sdk/resource-manager/network/2023-09-01/securityrules` Documentation

The `securityrules` SDK allows for interaction with the Azure Resource Manager Service `network` (API Version `2023-09-01`).
...
```go
import "github.com/tombuildsstuff/go-azure-sdk/resource-manager/network/2023-09-01/securityrules"
```
