...
## `github.com/tombuildsstuff/go-azure-sdk/resource-manager/network/2023-06-01/virtualrouterpeerings` Documentation

The `virtualrouterpeerings` SDK allows for interaction with the Azure Resource Manager Service `network` (API Version `2023-06-01`).
...
```go
import "github.com/tombuildsstuff/go-azure-sdk/resource-manager/network/2023-06-01/virtualrouterpeerings"
```
