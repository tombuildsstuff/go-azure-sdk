...
## `github.com/tombuildsstuff/go-azure-sdk/resource-manager/databricks/2023-02-01/workspaces` Documentation

The `workspaces` SDK allows for interaction with the Azure Resource Manager Service `databricks` (API Version `2023-02-01`).
...
```go
import "github.com/tombuildsstuff/go-azure-sdk/resource-manager/databricks/2023-02-01/workspaces"
```
