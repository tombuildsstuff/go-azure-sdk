...
## `github.com/tombuildsstuff/go-azure-sdk/resource-manager/databricks/2022-04-01-preview/privateendpointconnections` Documentation

The `privateendpointconnections` SDK allows for interaction with the Azure Resource Manager Service `databricks` (API Version `2022-04-01-preview`).
...
```go
import "github.com/tombuildsstuff/go-azure-sdk/resource-manager/databricks/2022-04-01-preview/privateendpointconnections"
```
