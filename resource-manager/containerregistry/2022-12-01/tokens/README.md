...
## `github.com/tombuildsstuff/go-azure-sdk/resource-manager/containerregistry/2022-12-01/tokens` Documentation

The `tokens` SDK allows for interaction with the Azure Resource Manager Service `containerregistry` (API Version `2022-12-01`).
...
```go
import "github.com/tombuildsstuff/go-azure-sdk/resource-manager/containerregistry/2022-12-01/tokens"
```
