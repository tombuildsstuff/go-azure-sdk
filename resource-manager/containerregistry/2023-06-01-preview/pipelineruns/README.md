...
## `github.com/tombuildsstuff/go-azure-sdk/resource-manager/containerregistry/2023-06-01-preview/pipelineruns` Documentation

The `pipelineruns` SDK allows for interaction with the Azure Resource Manager Service `containerregistry` (API Version `2023-06-01-preview`).
...
```go
import "github.com/tombuildsstuff/go-azure-sdk/resource-manager/containerregistry/2023-06-01-preview/pipelineruns"
```
