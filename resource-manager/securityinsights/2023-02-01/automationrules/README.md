...
## `github.com/tombuildsstuff/go-azure-sdk/resource-manager/securityinsights/2023-02-01/automationrules` Documentation

The `automationrules` SDK allows for interaction with the Azure Resource Manager Service `securityinsights` (API Version `2023-02-01`).
...
```go
import "github.com/tombuildsstuff/go-azure-sdk/resource-manager/securityinsights/2023-02-01/automationrules"
```
