...
## `github.com/tombuildsstuff/go-azure-sdk/resource-manager/keyvault/2022-11-01/privateendpointconnections` Documentation

The `privateendpointconnections` SDK allows for interaction with the Azure Resource Manager Service `keyvault` (API Version `2022-11-01`).
...
```go
import "github.com/tombuildsstuff/go-azure-sdk/resource-manager/keyvault/2022-11-01/privateendpointconnections"
```
