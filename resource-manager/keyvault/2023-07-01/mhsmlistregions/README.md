...
## `github.com/tombuildsstuff/go-azure-sdk/resource-manager/keyvault/2023-07-01/mhsmlistregions` Documentation

The `mhsmlistregions` SDK allows for interaction with the Azure Resource Manager Service `keyvault` (API Version `2023-07-01`).
...
```go
import "github.com/tombuildsstuff/go-azure-sdk/resource-manager/keyvault/2023-07-01/mhsmlistregions"
```
