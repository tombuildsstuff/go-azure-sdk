...
## `github.com/tombuildsstuff/go-azure-sdk/resource-manager/keyvault/2021-10-01/mhsmprivateendpointconnections` Documentation

The `mhsmprivateendpointconnections` SDK allows for interaction with the Azure Resource Manager Service `keyvault` (API Version `2021-10-01`).
...
```go
import "github.com/tombuildsstuff/go-azure-sdk/resource-manager/keyvault/2021-10-01/mhsmprivateendpointconnections"
```
