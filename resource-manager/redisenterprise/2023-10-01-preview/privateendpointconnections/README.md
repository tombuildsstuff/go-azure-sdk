...
## `github.com/tombuildsstuff/go-azure-sdk/resource-manager/redisenterprise/2023-10-01-preview/privateendpointconnections` Documentation

The `privateendpointconnections` SDK allows for interaction with the Azure Resource Manager Service `redisenterprise` (API Version `2023-10-01-preview`).
...
```go
import "github.com/tombuildsstuff/go-azure-sdk/resource-manager/redisenterprise/2023-10-01-preview/privateendpointconnections"
```
