...
import (
	...
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/machinelearningservices/2023-10-01/batchdeployment"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/machinelearningservices/2023-10-01/batchendpoint"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/machinelearningservices/2023-10-01/codecontainer"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/machinelearningservices/2023-10-01/codeversion"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/machinelearningservices/2023-10-01/componentcontainer"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/machinelearningservices/2023-10-01/componentversion"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/machinelearningservices/2023-10-01/datacontainer"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/machinelearningservices/2023-10-01/datacontainerregistry"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/machinelearningservices/2023-10-01/datareference"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/machinelearningservices/2023-10-01/datastore"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/machinelearningservices/2023-10-01/dataversion"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/machinelearningservices/2023-10-01/dataversionregistry"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/machinelearningservices/2023-10-01/environmentcontainer"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/machinelearningservices/2023-10-01/environmentversion"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/machinelearningservices/2023-10-01/feature"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/machinelearningservices/2023-10-01/featuresetcontainer"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/machinelearningservices/2023-10-01/featuresetversion"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/machinelearningservices/2023-10-01/featurestoreentitycontainer"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/machinelearningservices/2023-10-01/featurestoreentityversion"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/machinelearningservices/2023-10-01/job"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/machinelearningservices/2023-10-01/machinelearningcomputes"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/machinelearningservices/2023-10-01/managednetwork"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/machinelearningservices/2023-10-01/modelcontainer"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/machinelearningservices/2023-10-01/modelversion"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/machinelearningservices/2023-10-01/onlinedeployment"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/machinelearningservices/2023-10-01/onlineendpoint"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/machinelearningservices/2023-10-01/operationalizationclusters"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/machinelearningservices/2023-10-01/outboundnetworkdependenciesendpoints"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/machinelearningservices/2023-10-01/privateendpointconnections"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/machinelearningservices/2023-10-01/proxyoperations"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/machinelearningservices/2023-10-01/quota"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/machinelearningservices/2023-10-01/registrymanagement"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/machinelearningservices/2023-10-01/schedule"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/machinelearningservices/2023-10-01/v2workspaceconnectionresource"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/machinelearningservices/2023-10-01/virtualmachinesizes"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/machinelearningservices/2023-10-01/workspaceprivateendpointconnections"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/machinelearningservices/2023-10-01/workspaceprivatelinkresources"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/machinelearningservices/2023-10-01/workspaces"
