...
## `github.com/tombuildsstuff/go-azure-sdk/resource-manager/datadog/2021-03-01/monitorsresource` Documentation

The `monitorsresource` SDK allows for interaction with the Azure Resource Manager Service `datadog` (API Version `2021-03-01`).
...
```go
import "github.com/tombuildsstuff/go-azure-sdk/resource-manager/datadog/2021-03-01/monitorsresource"
```
