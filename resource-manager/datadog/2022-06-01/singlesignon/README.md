...
## `github.com/tombuildsstuff/go-azure-sdk/resource-manager/datadog/2022-06-01/singlesignon` Documentation

The `singlesignon` SDK allows for interaction with the Azure Resource Manager Service `datadog` (API Version `2022-06-01`).
...
```go
import "github.com/tombuildsstuff/go-azure-sdk/resource-manager/datadog/2022-06-01/singlesignon"
```
