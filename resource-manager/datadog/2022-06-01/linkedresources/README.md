...
## `github.com/tombuildsstuff/go-azure-sdk/resource-manager/datadog/2022-06-01/linkedresources` Documentation

The `linkedresources` SDK allows for interaction with the Azure Resource Manager Service `datadog` (API Version `2022-06-01`).
...
```go
import "github.com/tombuildsstuff/go-azure-sdk/resource-manager/datadog/2022-06-01/linkedresources"
```
