...
## `github.com/tombuildsstuff/go-azure-sdk/resource-manager/web/2023-01-01/recommendations` Documentation

The `recommendations` SDK allows for interaction with the Azure Resource Manager Service `web` (API Version `2023-01-01`).
...
```go
import "github.com/tombuildsstuff/go-azure-sdk/resource-manager/web/2023-01-01/recommendations"
```
