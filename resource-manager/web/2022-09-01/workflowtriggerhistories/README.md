...
## `github.com/tombuildsstuff/go-azure-sdk/resource-manager/web/2022-09-01/workflowtriggerhistories` Documentation

The `workflowtriggerhistories` SDK allows for interaction with the Azure Resource Manager Service `web` (API Version `2022-09-01`).
...
```go
import "github.com/tombuildsstuff/go-azure-sdk/resource-manager/web/2022-09-01/workflowtriggerhistories"
```
