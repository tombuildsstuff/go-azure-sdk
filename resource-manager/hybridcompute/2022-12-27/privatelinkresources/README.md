...
## `github.com/tombuildsstuff/go-azure-sdk/resource-manager/hybridcompute/2022-12-27/privatelinkresources` Documentation

The `privatelinkresources` SDK allows for interaction with the Azure Resource Manager Service `hybridcompute` (API Version `2022-12-27`).
...
```go
import "github.com/tombuildsstuff/go-azure-sdk/resource-manager/hybridcompute/2022-12-27/privatelinkresources"
```
