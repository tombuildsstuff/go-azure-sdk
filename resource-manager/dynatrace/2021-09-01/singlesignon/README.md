...
## `github.com/tombuildsstuff/go-azure-sdk/resource-manager/dynatrace/2021-09-01/singlesignon` Documentation

The `singlesignon` SDK allows for interaction with the Azure Resource Manager Service `dynatrace` (API Version `2021-09-01`).
...
```go
import "github.com/tombuildsstuff/go-azure-sdk/resource-manager/dynatrace/2021-09-01/singlesignon"
```
