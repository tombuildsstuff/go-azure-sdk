...
## `github.com/tombuildsstuff/go-azure-sdk/resource-manager/managedservices/2022-10-01/registrationassignments` Documentation
...
```go
import "github.com/tombuildsstuff/go-azure-sdk/resource-manager/managedservices/2022-10-01/registrationassignments"
```
...
```go
ctx := context.TODO()
id := registrationassignments.NewScopeID("/subscriptions/12345678-1234-9876-4563-123456789012/resourceGroups/some-resource-group")
