...
## `github.com/tombuildsstuff/go-azure-sdk/resource-manager/postgresql/2022-12-01/configurations` Documentation

The `configurations` SDK allows for interaction with the Azure Resource Manager Service `postgresql` (API Version `2022-12-01`).
...
```go
import "github.com/tombuildsstuff/go-azure-sdk/resource-manager/postgresql/2022-12-01/configurations"
```
