...
// ListByServer ...
func (c TopQueryStatisticsClient) ListByServer(ctx context.Context, id ServerId) (result ListByServerOperationResponse, err error) {
...
func (c TopQueryStatisticsClient) ListByServerComplete(ctx context.Context, id ServerId) (ListByServerCompleteResult, error) {
	return c.ListByServerCompleteMatchingPredicate(ctx, id, QueryStatisticOperationPredicate{})
}

// ListByServerCompleteMatchingPredicate retrieves all the results and then applies the predicate
func (c TopQueryStatisticsClient) ListByServerCompleteMatchingPredicate(ctx context.Context, id ServerId, predicate QueryStatisticOperationPredicate) (result ListByServerCompleteResult, err error) {
