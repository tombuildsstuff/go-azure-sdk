...
## `github.com/tombuildsstuff/go-azure-sdk/resource-manager/postgresql/2022-03-08-preview/backups` Documentation

The `backups` SDK allows for interaction with the Azure Resource Manager Service `postgresql` (API Version `2022-03-08-preview`).
...
```go
import "github.com/tombuildsstuff/go-azure-sdk/resource-manager/postgresql/2022-03-08-preview/backups"
```
