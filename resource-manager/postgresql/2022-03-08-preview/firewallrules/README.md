...
## `github.com/tombuildsstuff/go-azure-sdk/resource-manager/postgresql/2022-03-08-preview/firewallrules` Documentation

The `firewallrules` SDK allows for interaction with the Azure Resource Manager Service `postgresql` (API Version `2022-03-08-preview`).
...
```go
import "github.com/tombuildsstuff/go-azure-sdk/resource-manager/postgresql/2022-03-08-preview/firewallrules"
```
