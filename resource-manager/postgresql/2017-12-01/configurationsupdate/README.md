...
## `github.com/tombuildsstuff/go-azure-sdk/resource-manager/postgresql/2017-12-01/configurationsupdate` Documentation

The `configurationsupdate` SDK allows for interaction with the Azure Resource Manager Service `postgresql` (API Version `2017-12-01`).
...
```go
import "github.com/tombuildsstuff/go-azure-sdk/resource-manager/postgresql/2017-12-01/configurationsupdate"
```
