...
## `github.com/tombuildsstuff/go-azure-sdk/resource-manager/healthcareapis/2023-11-01/dicomservices` Documentation

The `dicomservices` SDK allows for interaction with the Azure Resource Manager Service `healthcareapis` (API Version `2023-11-01`).
...
```go
import "github.com/tombuildsstuff/go-azure-sdk/resource-manager/healthcareapis/2023-11-01/dicomservices"
```
