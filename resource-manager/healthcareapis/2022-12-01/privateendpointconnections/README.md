...
## `github.com/tombuildsstuff/go-azure-sdk/resource-manager/healthcareapis/2022-12-01/privateendpointconnections` Documentation

The `privateendpointconnections` SDK allows for interaction with the Azure Resource Manager Service `healthcareapis` (API Version `2022-12-01`).
...
```go
import "github.com/tombuildsstuff/go-azure-sdk/resource-manager/healthcareapis/2022-12-01/privateendpointconnections"
```
