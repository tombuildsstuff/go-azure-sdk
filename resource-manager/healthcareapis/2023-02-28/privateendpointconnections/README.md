...
## `github.com/tombuildsstuff/go-azure-sdk/resource-manager/healthcareapis/2023-02-28/privateendpointconnections` Documentation

The `privateendpointconnections` SDK allows for interaction with the Azure Resource Manager Service `healthcareapis` (API Version `2023-02-28`).
...
```go
import "github.com/tombuildsstuff/go-azure-sdk/resource-manager/healthcareapis/2023-02-28/privateendpointconnections"
```
