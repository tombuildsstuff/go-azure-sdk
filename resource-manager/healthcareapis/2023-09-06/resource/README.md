...
## `github.com/tombuildsstuff/go-azure-sdk/resource-manager/healthcareapis/2023-09-06/resource` Documentation

The `resource` SDK allows for interaction with the Azure Resource Manager Service `healthcareapis` (API Version `2023-09-06`).
...
```go
import "github.com/tombuildsstuff/go-azure-sdk/resource-manager/healthcareapis/2023-09-06/resource"
```
