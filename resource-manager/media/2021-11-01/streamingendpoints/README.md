...
## `github.com/tombuildsstuff/go-azure-sdk/resource-manager/media/2021-11-01/streamingendpoints` Documentation

The `streamingendpoints` SDK allows for interaction with the Azure Resource Manager Service `media` (API Version `2021-11-01`).
...
```go
import "github.com/tombuildsstuff/go-azure-sdk/resource-manager/media/2021-11-01/streamingendpoints"
```
