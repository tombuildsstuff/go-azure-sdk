...
## `github.com/tombuildsstuff/go-azure-sdk/resource-manager/compute/2021-07-01/galleryimages` Documentation
...
```go
import "github.com/tombuildsstuff/go-azure-sdk/resource-manager/compute/2021-07-01/galleryimages"
```
...
```go
ctx := context.TODO()
id := galleryimages.NewSharedImageGalleryID("12345678-1234-9876-4563-123456789012", "example-resource-group", "galleryValue")
