...
## `github.com/tombuildsstuff/go-azure-sdk/resource-manager/compute/2023-04-02/diskaccesses` Documentation

The `diskaccesses` SDK allows for interaction with the Azure Resource Manager Service `compute` (API Version `2023-04-02`).
...
```go
import "github.com/tombuildsstuff/go-azure-sdk/resource-manager/compute/2023-04-02/diskaccesses"
```
