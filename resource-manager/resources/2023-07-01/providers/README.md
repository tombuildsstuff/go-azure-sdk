...
## `github.com/tombuildsstuff/go-azure-sdk/resource-manager/resources/2023-07-01/providers` Documentation

The `providers` SDK allows for interaction with the Azure Resource Manager Service `resources` (API Version `2023-07-01`).
...
```go
import "github.com/tombuildsstuff/go-azure-sdk/resource-manager/resources/2023-07-01/providers"
```
