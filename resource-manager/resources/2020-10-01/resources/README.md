...
## `github.com/tombuildsstuff/go-azure-sdk/resource-manager/resources/2020-10-01/resources` Documentation

The `resources` SDK allows for interaction with the Azure Resource Manager Service `resources` (API Version `2020-10-01`).
...
```go
import "github.com/tombuildsstuff/go-azure-sdk/resource-manager/resources/2020-10-01/resources"
```
