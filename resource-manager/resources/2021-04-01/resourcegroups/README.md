...
## `github.com/tombuildsstuff/go-azure-sdk/resource-manager/resources/2021-04-01/resourcegroups` Documentation

The `resourcegroups` SDK allows for interaction with the Azure Resource Manager Service `resources` (API Version `2021-04-01`).
...
```go
import "github.com/tombuildsstuff/go-azure-sdk/resource-manager/resources/2021-04-01/resourcegroups"
```
