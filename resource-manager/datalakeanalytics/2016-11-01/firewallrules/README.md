...
## `github.com/tombuildsstuff/go-azure-sdk/resource-manager/datalakeanalytics/2016-11-01/firewallrules` Documentation

The `firewallrules` SDK allows for interaction with the Azure Resource Manager Service `datalakeanalytics` (API Version `2016-11-01`).
...
```go
import "github.com/tombuildsstuff/go-azure-sdk/resource-manager/datalakeanalytics/2016-11-01/firewallrules"
```
