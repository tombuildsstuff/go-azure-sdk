...
## `github.com/tombuildsstuff/go-azure-sdk/resource-manager/cosmosdb/2022-11-15/sqldedicatedgateway` Documentation

The `sqldedicatedgateway` SDK allows for interaction with the Azure Resource Manager Service `cosmosdb` (API Version `2022-11-15`).
...
```go
import "github.com/tombuildsstuff/go-azure-sdk/resource-manager/cosmosdb/2022-11-15/sqldedicatedgateway"
```
