...
## `github.com/tombuildsstuff/go-azure-sdk/resource-manager/advisor/2020-01-01/suppressions` Documentation

The `suppressions` SDK allows for interaction with the Azure Resource Manager Service `advisor` (API Version `2020-01-01`).
...
```go
import "github.com/tombuildsstuff/go-azure-sdk/resource-manager/advisor/2020-01-01/suppressions"
```
