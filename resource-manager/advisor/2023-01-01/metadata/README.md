...
## `github.com/tombuildsstuff/go-azure-sdk/resource-manager/advisor/2023-01-01/metadata` Documentation

The `metadata` SDK allows for interaction with the Azure Resource Manager Service `advisor` (API Version `2023-01-01`).
...
```go
import "github.com/tombuildsstuff/go-azure-sdk/resource-manager/advisor/2023-01-01/metadata"
```
