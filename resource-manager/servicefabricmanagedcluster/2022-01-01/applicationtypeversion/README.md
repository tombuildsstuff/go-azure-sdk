...
## `github.com/tombuildsstuff/go-azure-sdk/resource-manager/servicefabricmanagedcluster/2022-01-01/applicationtypeversion` Documentation

The `applicationtypeversion` SDK allows for interaction with the Azure Resource Manager Service `servicefabricmanagedcluster` (API Version `2022-01-01`).
...
```go
import "github.com/tombuildsstuff/go-azure-sdk/resource-manager/servicefabricmanagedcluster/2022-01-01/applicationtypeversion"
```
