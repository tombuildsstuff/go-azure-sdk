...
## `github.com/tombuildsstuff/go-azure-sdk/resource-manager/netapp/2023-05-01/snapshotpolicylistvolumes` Documentation

The `snapshotpolicylistvolumes` SDK allows for interaction with the Azure Resource Manager Service `netapp` (API Version `2023-05-01`).
...
```go
import "github.com/tombuildsstuff/go-azure-sdk/resource-manager/netapp/2023-05-01/snapshotpolicylistvolumes"
```
