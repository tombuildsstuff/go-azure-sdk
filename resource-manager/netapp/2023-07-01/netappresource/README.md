...
## `github.com/tombuildsstuff/go-azure-sdk/resource-manager/netapp/2023-07-01/netappresource` Documentation

The `netappresource` SDK allows for interaction with the Azure Resource Manager Service `netapp` (API Version `2023-07-01`).
...
```go
import "github.com/tombuildsstuff/go-azure-sdk/resource-manager/netapp/2023-07-01/netappresource"
```
