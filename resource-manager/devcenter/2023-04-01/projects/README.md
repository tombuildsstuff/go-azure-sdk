...
## `github.com/tombuildsstuff/go-azure-sdk/resource-manager/devcenter/2023-04-01/projects` Documentation
...
```go
import "github.com/tombuildsstuff/go-azure-sdk/resource-manager/devcenter/2023-04-01/projects"
```
...
```go
ctx := context.TODO()
id := projects.NewResourceGroupID("12345678-1234-9876-4563-123456789012", "example-resource-group")
...
```go
ctx := context.TODO()
id := projects.NewSubscriptionID("12345678-1234-9876-4563-123456789012")
