...
## `github.com/tombuildsstuff/go-azure-sdk/resource-manager/nginx/2022-08-01/nginxconfiguration` Documentation

The `nginxconfiguration` SDK allows for interaction with the Azure Resource Manager Service `nginx` (API Version `2022-08-01`).
...
```go
import "github.com/tombuildsstuff/go-azure-sdk/resource-manager/nginx/2022-08-01/nginxconfiguration"
```
