...
## `github.com/tombuildsstuff/go-azure-sdk/resource-manager/insights/2019-10-17-preview/privateendpointconnections` Documentation

The `privateendpointconnections` SDK allows for interaction with the Azure Resource Manager Service `insights` (API Version `2019-10-17-preview`).
...
```go
import "github.com/tombuildsstuff/go-azure-sdk/resource-manager/insights/2019-10-17-preview/privateendpointconnections"
```
