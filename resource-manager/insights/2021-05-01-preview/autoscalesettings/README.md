...
## `github.com/tombuildsstuff/go-azure-sdk/resource-manager/insights/2021-05-01-preview/autoscalesettings` Documentation

The `autoscalesettings` SDK allows for interaction with the Azure Resource Manager Service `insights` (API Version `2021-05-01-preview`).
...
```go
import "github.com/tombuildsstuff/go-azure-sdk/resource-manager/insights/2021-05-01-preview/autoscalesettings"
```
