...
## `github.com/tombuildsstuff/go-azure-sdk/resource-manager/insights/2022-06-01/datacollectionendpoints` Documentation
...
```go
import "github.com/tombuildsstuff/go-azure-sdk/resource-manager/insights/2022-06-01/datacollectionendpoints"
```
...
```go
ctx := context.TODO()
id := datacollectionendpoints.NewResourceGroupID("12345678-1234-9876-4563-123456789012", "example-resource-group")
...
```go
ctx := context.TODO()
id := datacollectionendpoints.NewSubscriptionID("12345678-1234-9876-4563-123456789012")
