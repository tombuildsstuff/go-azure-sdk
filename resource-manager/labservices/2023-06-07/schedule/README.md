...
## `github.com/tombuildsstuff/go-azure-sdk/resource-manager/labservices/2023-06-07/schedule` Documentation

The `schedule` SDK allows for interaction with the Azure Resource Manager Service `labservices` (API Version `2023-06-07`).
...
```go
import "github.com/tombuildsstuff/go-azure-sdk/resource-manager/labservices/2023-06-07/schedule"
```
