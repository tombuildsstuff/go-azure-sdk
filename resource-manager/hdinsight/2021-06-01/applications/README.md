...
## `github.com/tombuildsstuff/go-azure-sdk/resource-manager/hdinsight/2021-06-01/applications` Documentation

The `applications` SDK allows for interaction with the Azure Resource Manager Service `hdinsight` (API Version `2021-06-01`).
...
```go
import "github.com/tombuildsstuff/go-azure-sdk/resource-manager/hdinsight/2021-06-01/applications"
```
