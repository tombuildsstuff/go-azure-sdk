...
## `github.com/tombuildsstuff/go-azure-sdk/resource-manager/hdinsight/2021-06-01/privateendpointconnections` Documentation

The `privateendpointconnections` SDK allows for interaction with the Azure Resource Manager Service `hdinsight` (API Version `2021-06-01`).
...
```go
import "github.com/tombuildsstuff/go-azure-sdk/resource-manager/hdinsight/2021-06-01/privateendpointconnections"
```
...
```go
ctx := context.TODO()
id := privateendpointconnections.NewHDInsightClusterID("12345678-1234-9876-4563-123456789012", "example-resource-group", "clusterValue")
