...
## `github.com/tombuildsstuff/go-azure-sdk/resource-manager/authorization/2018-01-01-preview/roledefinitions` Documentation

The `roledefinitions` SDK allows for interaction with the Azure Resource Manager Service `authorization` (API Version `2018-01-01-preview`).
...
```go
import "github.com/tombuildsstuff/go-azure-sdk/resource-manager/authorization/2018-01-01-preview/roledefinitions"
```
