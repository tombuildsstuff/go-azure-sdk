...
## `github.com/tombuildsstuff/go-azure-sdk/resource-manager/vmware/2022-05-01/virtualmachines` Documentation

The `virtualmachines` SDK allows for interaction with the Azure Resource Manager Service `vmware` (API Version `2022-05-01`).
...
```go
import "github.com/tombuildsstuff/go-azure-sdk/resource-manager/vmware/2022-05-01/virtualmachines"
```
