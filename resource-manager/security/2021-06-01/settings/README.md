...
## `github.com/tombuildsstuff/go-azure-sdk/resource-manager/security/2021-06-01/settings` Documentation

The `settings` SDK allows for interaction with the Azure Resource Manager Service `security` (API Version `2021-06-01`).
...
```go
import "github.com/tombuildsstuff/go-azure-sdk/resource-manager/security/2021-06-01/settings"
```
