...
## `github.com/tombuildsstuff/go-azure-sdk/resource-manager/security/2022-03-01/pricings` Documentation

The `pricings` SDK allows for interaction with the Azure Resource Manager Service `security` (API Version `2022-03-01`).
...
```go
import "github.com/tombuildsstuff/go-azure-sdk/resource-manager/security/2022-03-01/pricings"
```
