...
## `github.com/tombuildsstuff/go-azure-sdk/resource-manager/dataprotection/2023-05-01/azurebackupjobs` Documentation

The `azurebackupjobs` SDK allows for interaction with the Azure Resource Manager Service `dataprotection` (API Version `2023-05-01`).
...
```go
import "github.com/tombuildsstuff/go-azure-sdk/resource-manager/dataprotection/2023-05-01/azurebackupjobs"
```
