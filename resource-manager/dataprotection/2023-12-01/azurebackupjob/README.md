...
## `github.com/tombuildsstuff/go-azure-sdk/resource-manager/dataprotection/2023-12-01/azurebackupjob` Documentation

The `azurebackupjob` SDK allows for interaction with the Azure Resource Manager Service `dataprotection` (API Version `2023-12-01`).
...
```go
import "github.com/tombuildsstuff/go-azure-sdk/resource-manager/dataprotection/2023-12-01/azurebackupjob"
```
