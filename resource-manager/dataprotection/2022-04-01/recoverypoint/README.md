...
## `github.com/tombuildsstuff/go-azure-sdk/resource-manager/dataprotection/2022-04-01/recoverypoint` Documentation

The `recoverypoint` SDK allows for interaction with the Azure Resource Manager Service `dataprotection` (API Version `2022-04-01`).
...
```go
import "github.com/tombuildsstuff/go-azure-sdk/resource-manager/dataprotection/2022-04-01/recoverypoint"
```
