...
import (
	...
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/apimanagement/2023-03-01-preview/api"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/apimanagement/2023-03-01-preview/apidiagnostic"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/apimanagement/2023-03-01-preview/apiissue"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/apimanagement/2023-03-01-preview/apiissueattachment"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/apimanagement/2023-03-01-preview/apiissuecomment"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/apimanagement/2023-03-01-preview/apimanagementservice"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/apimanagement/2023-03-01-preview/apimanagementserviceskus"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/apimanagement/2023-03-01-preview/apioperation"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/apimanagement/2023-03-01-preview/apioperationpolicy"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/apimanagement/2023-03-01-preview/apioperationsbytag"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/apimanagement/2023-03-01-preview/apioperationtag"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/apimanagement/2023-03-01-preview/apipolicy"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/apimanagement/2023-03-01-preview/apiproduct"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/apimanagement/2023-03-01-preview/apirelease"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/apimanagement/2023-03-01-preview/apirevision"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/apimanagement/2023-03-01-preview/apisbytag"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/apimanagement/2023-03-01-preview/apischema"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/apimanagement/2023-03-01-preview/apitag"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/apimanagement/2023-03-01-preview/apitagdescription"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/apimanagement/2023-03-01-preview/apiversionset"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/apimanagement/2023-03-01-preview/apiversionsets"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/apimanagement/2023-03-01-preview/apiwiki"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/apimanagement/2023-03-01-preview/authorization"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/apimanagement/2023-03-01-preview/authorizationaccesspolicy"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/apimanagement/2023-03-01-preview/authorizationconfirmconsentcode"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/apimanagement/2023-03-01-preview/authorizationloginlinks"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/apimanagement/2023-03-01-preview/authorizationprovider"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/apimanagement/2023-03-01-preview/authorizations"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/apimanagement/2023-03-01-preview/authorizationserver"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/apimanagement/2023-03-01-preview/backend"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/apimanagement/2023-03-01-preview/backendreconnect"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/apimanagement/2023-03-01-preview/cache"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/apimanagement/2023-03-01-preview/certificate"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/apimanagement/2023-03-01-preview/contenttype"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/apimanagement/2023-03-01-preview/contenttypecontentitem"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/apimanagement/2023-03-01-preview/delegationsettings"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/apimanagement/2023-03-01-preview/deletedservice"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/apimanagement/2023-03-01-preview/diagnostic"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/apimanagement/2023-03-01-preview/documentationresource"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/apimanagement/2023-03-01-preview/emailtemplate"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/apimanagement/2023-03-01-preview/emailtemplates"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/apimanagement/2023-03-01-preview/gateway"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/apimanagement/2023-03-01-preview/gatewayapi"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/apimanagement/2023-03-01-preview/gatewaycertificateauthority"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/apimanagement/2023-03-01-preview/gatewaygeneratetoken"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/apimanagement/2023-03-01-preview/gatewayhostnameconfiguration"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/apimanagement/2023-03-01-preview/gatewayinvalidatedebugcredentials"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/apimanagement/2023-03-01-preview/gatewaylistdebugcredentials"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/apimanagement/2023-03-01-preview/gatewaylistkeys"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/apimanagement/2023-03-01-preview/gatewaylisttrace"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/apimanagement/2023-03-01-preview/gatewayregeneratekey"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/apimanagement/2023-03-01-preview/graphqlapiresolver"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/apimanagement/2023-03-01-preview/graphqlapiresolverpolicy"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/apimanagement/2023-03-01-preview/group"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/apimanagement/2023-03-01-preview/groupuser"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/apimanagement/2023-03-01-preview/identityprovider"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/apimanagement/2023-03-01-preview/issue"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/apimanagement/2023-03-01-preview/logger"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/apimanagement/2023-03-01-preview/namedvalue"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/apimanagement/2023-03-01-preview/networkstatus"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/apimanagement/2023-03-01-preview/notification"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/apimanagement/2023-03-01-preview/notificationrecipientemail"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/apimanagement/2023-03-01-preview/notificationrecipientuser"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/apimanagement/2023-03-01-preview/openidconnectprovider"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/apimanagement/2023-03-01-preview/outboundnetworkdependenciesendpoints"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/apimanagement/2023-03-01-preview/performconnectivitycheck"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/apimanagement/2023-03-01-preview/policy"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/apimanagement/2023-03-01-preview/policydescription"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/apimanagement/2023-03-01-preview/policyfragment"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/apimanagement/2023-03-01-preview/portalconfig"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/apimanagement/2023-03-01-preview/portalrevision"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/apimanagement/2023-03-01-preview/portalsettings"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/apimanagement/2023-03-01-preview/privateendpointconnections"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/apimanagement/2023-03-01-preview/product"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/apimanagement/2023-03-01-preview/productapi"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/apimanagement/2023-03-01-preview/productapilink"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/apimanagement/2023-03-01-preview/productgroup"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/apimanagement/2023-03-01-preview/productgrouplink"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/apimanagement/2023-03-01-preview/productpolicy"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/apimanagement/2023-03-01-preview/productsbytag"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/apimanagement/2023-03-01-preview/productsubscription"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/apimanagement/2023-03-01-preview/producttag"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/apimanagement/2023-03-01-preview/productwiki"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/apimanagement/2023-03-01-preview/quotabycounterkeys"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/apimanagement/2023-03-01-preview/quotabyperiodkeys"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/apimanagement/2023-03-01-preview/region"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/apimanagement/2023-03-01-preview/reports"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/apimanagement/2023-03-01-preview/schema"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/apimanagement/2023-03-01-preview/signinsettings"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/apimanagement/2023-03-01-preview/signupsettings"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/apimanagement/2023-03-01-preview/skus"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/apimanagement/2023-03-01-preview/subscription"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/apimanagement/2023-03-01-preview/tag"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/apimanagement/2023-03-01-preview/tagapilink"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/apimanagement/2023-03-01-preview/tagoperationlink"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/apimanagement/2023-03-01-preview/tagproductlink"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/apimanagement/2023-03-01-preview/tagresource"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/apimanagement/2023-03-01-preview/tenantaccess"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/apimanagement/2023-03-01-preview/tenantaccessgit"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/apimanagement/2023-03-01-preview/tenantconfiguration"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/apimanagement/2023-03-01-preview/tenantconfigurationsyncstate"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/apimanagement/2023-03-01-preview/tenantsettings"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/apimanagement/2023-03-01-preview/user"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/apimanagement/2023-03-01-preview/userconfirmationpasswordsend"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/apimanagement/2023-03-01-preview/usergroup"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/apimanagement/2023-03-01-preview/useridentity"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/apimanagement/2023-03-01-preview/users"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/apimanagement/2023-03-01-preview/usersubscription"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/apimanagement/2023-03-01-preview/usertoken"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/apimanagement/2023-03-01-preview/workspace"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/apimanagement/2023-03-01-preview/workspacepolicy"
