...
import (
	...
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/apimanagement/2022-08-01/api"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/apimanagement/2022-08-01/apidiagnostic"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/apimanagement/2022-08-01/apiissue"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/apimanagement/2022-08-01/apiissueattachment"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/apimanagement/2022-08-01/apiissuecomment"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/apimanagement/2022-08-01/apimanagementservice"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/apimanagement/2022-08-01/apimanagementserviceskus"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/apimanagement/2022-08-01/apioperation"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/apimanagement/2022-08-01/apioperationpolicy"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/apimanagement/2022-08-01/apioperationsbytag"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/apimanagement/2022-08-01/apioperationtag"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/apimanagement/2022-08-01/apipolicy"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/apimanagement/2022-08-01/apiproduct"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/apimanagement/2022-08-01/apirelease"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/apimanagement/2022-08-01/apirevision"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/apimanagement/2022-08-01/apisbytag"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/apimanagement/2022-08-01/apischema"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/apimanagement/2022-08-01/apitag"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/apimanagement/2022-08-01/apitagdescription"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/apimanagement/2022-08-01/apiversionset"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/apimanagement/2022-08-01/apiversionsets"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/apimanagement/2022-08-01/apiwiki"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/apimanagement/2022-08-01/authorization"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/apimanagement/2022-08-01/authorizationaccesspolicy"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/apimanagement/2022-08-01/authorizationconfirmconsentcode"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/apimanagement/2022-08-01/authorizationloginlinks"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/apimanagement/2022-08-01/authorizationprovider"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/apimanagement/2022-08-01/authorizations"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/apimanagement/2022-08-01/authorizationserver"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/apimanagement/2022-08-01/backend"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/apimanagement/2022-08-01/backendreconnect"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/apimanagement/2022-08-01/cache"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/apimanagement/2022-08-01/certificate"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/apimanagement/2022-08-01/contenttype"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/apimanagement/2022-08-01/contenttypecontentitem"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/apimanagement/2022-08-01/delegationsettings"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/apimanagement/2022-08-01/deletedservice"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/apimanagement/2022-08-01/diagnostic"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/apimanagement/2022-08-01/documentationresource"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/apimanagement/2022-08-01/emailtemplate"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/apimanagement/2022-08-01/emailtemplates"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/apimanagement/2022-08-01/gateway"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/apimanagement/2022-08-01/gatewayapi"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/apimanagement/2022-08-01/gatewaycertificateauthority"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/apimanagement/2022-08-01/gatewaygeneratetoken"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/apimanagement/2022-08-01/gatewayhostnameconfiguration"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/apimanagement/2022-08-01/gatewaylistkeys"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/apimanagement/2022-08-01/gatewayregeneratekey"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/apimanagement/2022-08-01/graphqlapiresolver"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/apimanagement/2022-08-01/graphqlapiresolverpolicy"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/apimanagement/2022-08-01/group"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/apimanagement/2022-08-01/groupuser"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/apimanagement/2022-08-01/identityprovider"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/apimanagement/2022-08-01/issue"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/apimanagement/2022-08-01/logger"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/apimanagement/2022-08-01/namedvalue"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/apimanagement/2022-08-01/networkstatus"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/apimanagement/2022-08-01/notification"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/apimanagement/2022-08-01/notificationrecipientemail"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/apimanagement/2022-08-01/notificationrecipientuser"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/apimanagement/2022-08-01/openidconnectprovider"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/apimanagement/2022-08-01/outboundnetworkdependenciesendpoints"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/apimanagement/2022-08-01/performconnectivitycheck"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/apimanagement/2022-08-01/policy"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/apimanagement/2022-08-01/policydescription"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/apimanagement/2022-08-01/policyfragment"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/apimanagement/2022-08-01/portalconfig"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/apimanagement/2022-08-01/portalrevision"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/apimanagement/2022-08-01/portalsettings"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/apimanagement/2022-08-01/privateendpointconnections"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/apimanagement/2022-08-01/product"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/apimanagement/2022-08-01/productapi"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/apimanagement/2022-08-01/productgroup"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/apimanagement/2022-08-01/productpolicy"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/apimanagement/2022-08-01/productsbytag"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/apimanagement/2022-08-01/productsubscription"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/apimanagement/2022-08-01/producttag"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/apimanagement/2022-08-01/productwiki"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/apimanagement/2022-08-01/quotabycounterkeys"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/apimanagement/2022-08-01/quotabyperiodkeys"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/apimanagement/2022-08-01/region"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/apimanagement/2022-08-01/reports"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/apimanagement/2022-08-01/schema"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/apimanagement/2022-08-01/signinsettings"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/apimanagement/2022-08-01/signupsettings"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/apimanagement/2022-08-01/skus"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/apimanagement/2022-08-01/subscription"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/apimanagement/2022-08-01/tag"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/apimanagement/2022-08-01/tagresource"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/apimanagement/2022-08-01/tenantaccess"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/apimanagement/2022-08-01/tenantaccessgit"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/apimanagement/2022-08-01/tenantconfiguration"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/apimanagement/2022-08-01/tenantconfigurationsyncstate"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/apimanagement/2022-08-01/tenantsettings"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/apimanagement/2022-08-01/user"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/apimanagement/2022-08-01/userconfirmationpasswordsend"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/apimanagement/2022-08-01/usergroup"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/apimanagement/2022-08-01/useridentity"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/apimanagement/2022-08-01/users"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/apimanagement/2022-08-01/usersubscription"
	"github.com/tombuildsstuff/go-azure-sdk/resource-manager/apimanagement/2022-08-01/usertoken"
