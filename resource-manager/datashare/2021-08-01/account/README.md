...
## `github.com/tombuildsstuff/go-azure-sdk/resource-manager/datashare/2021-08-01/account` Documentation

The `account` SDK allows for interaction with the Azure Resource Manager Service `datashare` (API Version `2021-08-01`).
...
```go
import "github.com/tombuildsstuff/go-azure-sdk/resource-manager/datashare/2021-08-01/account"
```
