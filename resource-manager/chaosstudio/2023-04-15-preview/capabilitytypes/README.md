...
## `github.com/tombuildsstuff/go-azure-sdk/resource-manager/chaosstudio/2023-04-15-preview/capabilitytypes` Documentation

The `capabilitytypes` SDK allows for interaction with the Azure Resource Manager Service `chaosstudio` (API Version `2023-04-15-preview`).
...
```go
import "github.com/tombuildsstuff/go-azure-sdk/resource-manager/chaosstudio/2023-04-15-preview/capabilitytypes"
```
