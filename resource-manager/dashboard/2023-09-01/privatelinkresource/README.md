...
## `github.com/tombuildsstuff/go-azure-sdk/resource-manager/dashboard/2023-09-01/privatelinkresource` Documentation

The `privatelinkresource` SDK allows for interaction with the Azure Resource Manager Service `dashboard` (API Version `2023-09-01`).
...
```go
import "github.com/tombuildsstuff/go-azure-sdk/resource-manager/dashboard/2023-09-01/privatelinkresource"
```
